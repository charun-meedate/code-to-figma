...
**6 โปรเจกต์ · 13 สิงหาคม 2026 · ทดสอบเฉพาะระดับ T1 (ดึง token) ทั้งหมด**
...
> **ระวังอย่าอ่านเกินกว่าที่มันบอก** — 6 รอบนี้ทดสอบ *การอ่านโค้ดออกมาเป็น token*
> เท่านั้น · ระดับ component / หน้าจอ / flow **ยังไม่เคยรันกับโปรเจกต์จริงเลยสักตัว**
...
**รวม 20 ปัญหา** · selftest จาก 38 → 60 ข้อ · ทุกข้อที่เจอถูกล็อกด้วย assertion
